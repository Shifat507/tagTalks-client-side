            ...
            <aside className="w-full md:w-64 bg-white shadow-md md:h-screen">
                ...
                <nav className="mt-8">
                    <ul className="space-y-4">
                        <li>
                            <Link to='/userProfile' className="block py-2 px-4 hover:bg-indigo-100 rounded-md">
                                My Profile
                            </Link>
                        </li>
                        <li>
                            <Link to='/createPost' className="block py-2 px-4 hover:bg-indigo-100 rounded-md">
                                Add Post
                            </Link>
                        </li>
                        <li>
                            <Link to='/myPosts' className="block py-2 px-4 hover:bg-indigo-100 rounded-md">
                                My Posts
                            </Link>
                        </li>
                    </ul>
